...
const SERVICE_LABELS: Record<string, string> = {
  ...
  ecommerce:    'E-Commerce Store Development',
  dashboard:    'SaaS Dashboard Development',
...
export default function InvoicePage() {
  ...
  useEffect(() => {
    paymentAPI.getOne(id)
      ...
      .catch((err) => setError(err?.response?.data?.message || 'Could not load invoice'))
  ...
  const serviceLabel = SERVICE_LABELS[serviceType] || 'Professional Development Services';
  const projectTitle = order?.title || project?.title || 'Development Project';
          ...
          <div className="p-10 print:p-10">
            ...
            <div className="flex items-start justify-between mb-10">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 leading-relaxed">
                  ...
                  Morocco — Available Worldwide<br />
                  hello@mbndev.com
                </p>
              </div>
            ...
            <div className="flex gap-8 mb-10 p-4 bg-slate-50 rounded-2xl print:bg-gray-50">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-700">
                  {payment.method ? METHOD_LABELS[payment.method] || payment.method : 'Manual'}
                </p>
              </div>
              {payment.externalRef && (
                <div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-100">
                    <th className="text-left py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Description</th>
                    <th className="text-center py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest w-16">Qty</th>
                    <th className="text-right py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest w-28">Amount</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="border-t border-gray-100 pt-6 flex items-center justify-between">
              <p className="text-xs text-gray-400 max-w-xs leading-relaxed">
                Thank you for your business. All deliverables and source code are transferred to the client upon full payment.
              </p>
              <div className="text-right">

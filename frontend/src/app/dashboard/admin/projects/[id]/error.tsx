...
export default function AdminProjectError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="min-h-[400px] flex items-center justify-center">
      <div className="text-center max-w-sm">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/dashboard/admin/projects" className="px-4 py-2 bg-white/5 border border-white/10 text-slate-300 text-sm font-medium rounded-xl hover:bg-white/10 transition-colors">
            Back to projects
          </Link>
        </div>
      </div>
